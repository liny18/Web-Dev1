  ...
  <div class="container-fluid">
    <div class="row flex-nowrap">
          ...
          <nav class="navbar nav-tabs nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" id="mbns">
                </ul>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" id="allPicks">
                </ul>
              </li>
      ...
      <div class="col py-3 align-content-center text-center right">
        ...
        <div class="btn btn-warning" id="refresh">
          Refresh
        </div>
                ...
                <form method="post">
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <button type="submit" class="btn btn-warning" name="next" id="next">Next</button>
                    </div>
                  </div>
                </form>
              </div>

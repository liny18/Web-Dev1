...
<head>
  ...
  <link rel="stylesheet" href="../resources/styles/dinning.css">
...
<body>
      ...
      <div class="row text-center">
        <div class="col-md">
          <div class="card">
            <div class="card-body text-center">
              <div class="h1 mb-3">
                <img src="../resources/pictures/commons.webp" style="height: 150px;" alt="" class="w-100">
              </div>
        ...
        <div class="col-md">
          <div class="card">
            <div class="card-body text-center">
              <div class="h1 mb-3">
                <img src="../resources/pictures/sage.jpeg" style="height: 150px;" alt="" class="w-100">
              </div>
        ...
        <div class="col-md">
          <div class="card">
            <div class="card-body text-center">
              <div class="h1 mb-3">
                <img src="../resources/pictures/blitman.jpeg" style="height: 150px;" alt="" class="w-100">
              </div>
        ...
        <div class="col-md">
          <div class="card">
            <div class="card-body text-center">
              <div class="h1 mb-3">
                <img src="../resources/pictures/barh.jpeg" style="height: 150px;" alt="" class="w-100">
              </div>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js"
    ...
    crossorigin="anonymous"></script>
  <script src="../resources/scripts/dinning.js"></script>
  <script async

            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item post mt-0">
                    <?php
                        ...
                        echo '<button class="bg-transparent border-none" type="submit" name="submit" value="submit" ><img src="../pictures/addPostIcon.svg" alt="profile" width="40" height="40"></button>';
                        echo '</form>';
                    ?>
                </li>
                <?php

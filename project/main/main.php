            ...
            for ($i = 0; $i < 10 && $i < $len; $i++) {
              ...
              if (str_contains($row[$i]['userID'], $_SESSION['query']) || str_contains(strtolower($row[$i]['mainComment']), $_SESSION['query']) || str_contains($row[$i]['location'], $_SESSION['query']) || str_contains($row[$i]['tag1'], $_SESSION['query']) || str_contains($row[$i]['foodName'], $_SESSION['query'])) {
                ...
                if (isset($_SESSION['admin']) && $_SESSION['admin'] == 1) {
                  ...
                  echo '<button type="submit" name="deleteAdmin" value="deleteAdmin" class="btn btn-link text-danger text-decoration-none">Yes</button>';
                  echo '</form>';
                  ...
                  if($row[$i]['userID'] == $_SESSION['userID']){
                    ...
                    echo '<form action="main.php" method="post">';
                    echo '<input type="hidden" name="postID" value=" ' . $row[$i]['postID'] . '"/>';
                    echo '<button type="submit" name="delete" value="delete" class="btn btn-link text-danger text-decoration-none">Yes</button>';
                    echo '</form>';
                    echo '<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>';
                    echo '</div>';
                    echo '</div>';
                    ...
                    echo '<div class="modal-body">';
                    echo '<div class="container">';
                    echo '<button type="button" class="btn btn-link text-danger text-decoration-none" onclick="report(' . $row[$i]['postID'] . ", " . $_SESSION['userID'] . ', this)">Yes</button>';
                    echo '<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
            ...
            for ($i = 0; $i < 10 && $i < $len; $i++) {
              ...
              if (isset($_SESSION['admin']) && $_SESSION['admin'] == 1) {
                ...
                if($row[$i]['userID'] == $_SESSION['userID']){
                  ...
                  echo '<div class="modal-body">';
                  echo '<div class="container">';
                  echo '<button type="button" class="me-3 btn btn-link text-danger text-decoration-none" onclick="report(' . $row[$i]['postID'] . ", " . $_SESSION['userID'] . ', this)">Yes</button>';
                  echo '<button type="button" class="btn btn-link text-secondary text-decoration-none" data-bs-dismiss="modal">No</button>';
                  echo '</div>';
                  echo '</div>';
                  echo '</div>';
                  echo '</div>';
